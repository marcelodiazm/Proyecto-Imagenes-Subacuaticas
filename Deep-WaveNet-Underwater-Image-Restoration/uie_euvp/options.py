...
parser.add_argument('--testing_dir_inp', default="/content/drive/MyDrive/PDI/a_limpiar/Train5_4/Train5_4_1/")
parser.add_argument('--testing_dir_gt', default="../pruebas/GT/")
